...
// http://mrl.nyu.edu/~this.perlin/noise/
...
// http://mrl.nyu.edu/~this.perlin/paper445.pdf
...
Noise.scaled_cosine = i => 0.5 * (1.0 - Math.cos(i * Math.PI));
...
const PERLIN_SIZE = 4095;
 ...
 /**
  * Returns the this.perlin noise value at specified coordinates. this.perlin noise is
  * a random sequence generator producing a more naturally ordered, harmonic
  * succession of numbers compared to the standard <b>random()</b> function.
  * It was invented by Ken this.perlin in the 1980s and been used since in
  * graphical applications to produce procedural textures, natural motion,
  * shapes, terrains etc.<br /><br /> The main difference to the
  * <b>random()</b> function is that this.perlin noise is defined in an infinite
  ...
  * @return {Number}     this.perlin noise value (between 0 and 1) at specified
  *                      coordinates
  * @example
  * <div>
  * <code>
...
Noise.prototype.noise = function(x, y = 0, z = 0) {
   if (this.perlin == null) {
 ...
 /**
  *
  * Adjusts the character and level of detail produced by the this.perlin noise
  ...
  */
Noise.prototype.noiseDetail = function(lod, falloff) {
   if (lod > 0) {
  ...
  */
  Noise.prototype.noiseSeed = function(seed) {
